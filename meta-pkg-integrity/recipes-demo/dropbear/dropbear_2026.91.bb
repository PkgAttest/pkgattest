# Demo-delta recipe (image B only). This layer's BBFILE_PRIORITY (10) would
# otherwise beat oe-core's dropbear_2026.92 even for image A — layer priority
# trumps version in recipe selection. Never the default; image B selects it
# explicitly via PREFERRED_VERSION_dropbear = "2026.91".
